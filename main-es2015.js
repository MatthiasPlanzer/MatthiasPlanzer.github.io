...
/* harmony import */ var _ionic_native_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/barcode-scanner/ngx */ "./node_modules/@ionic-native/barcode-scanner/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _data_timespan__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data/timespan */ "./src/app/data/timespan.ts");
        ...
        for (const current of data) {
            ...
            switch (timespan) {
                case _data_timespan__WEBPACK_IMPORTED_MODULE_5__["Timespan"].month:
                    index = current.addDate.toLocaleString('default', { month: 'long' }) + ' ' + current.addDate.getFullYear();
                    break;
...
module.exports = __webpack_require__(/*! /home/runner/work/NutriInfo/NutriInfo/src/main.ts */"./src/main.ts");
